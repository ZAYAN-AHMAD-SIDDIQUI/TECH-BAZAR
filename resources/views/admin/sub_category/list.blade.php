        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('sub-categories.create') }}" class="btn btn-primary">New SubCategory</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                                ...
                                @foreach ($subCategories as $subCategory)
                                    <tr>
                                        ...
                                        <a href="" onclick="deleteSubcategory({{$subCategory->id}})">
                                            <svg class="text-danger w-4 h-4 mr-1" wire:loading.remove.delay=""
                                                wire:target="" class="filament-link-icon w-4 h-4 mr-1"
