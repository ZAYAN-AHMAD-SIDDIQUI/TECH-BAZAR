                                ...
                                @foreach ($wishlists as $wishlist)
                                    <div class="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom">
                                        <div class="d-block d-sm-flex align-items-start text-center text-sm-start">
                                            ...
                                            @php
                                                $productImage = getProductImage($wishlist->product->id);
                                            @endphp
                                            ...
                                            <div class="pt-2">
                                                ...
                                                <div class="fs-lg text-accent pt-2"> <span
                                                    ...
                                                    @if ($wishlist->product->compare_price > 0)
                                                        <span
                                                            class="h6 text-underline"><small><del>${{ $wishlist->product->compare_price }}</del></small></span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                                            <button onclick="removeproduct({{ $wishlist->product->id }});"
